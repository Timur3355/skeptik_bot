...
TOPICS = [
    ...
    "финансовые махинации Ozon: как убытки маскируют под рост",
    "Магнит: падение рентабельности и рост долгов",
    "Wildberries: операционная прибыль и скрытые потери",
    "Ozon: как инфляция и курс рубля влияют на выручку",
    "неэффективные инвестиции ритейлеров в новые направления",
    "сезонность и её влияние на прибыль ритейлеров",
    "как ритейлеры списывают товары и манипулируют отчётностью",
    # Взаимодействие с продавцами
    "штрафы и возвраты Wildberries: как компания зарабатывает на продавцах",
    "комиссии маркетплейсов: сколько на самом деле забирают платформы",
    "условия поставок для продавцов: скрытые платежи и санкции",
    "как маркетплейсы меняют правила игры для малого бизнеса",
    "споры продавцов с Wildberries и Ozon: судебная статистика",
    # Маркетинг и клиенты
    "стратегия экспансии Магнита: открытие и закрытие магазинов, эффективность",
    "как ритейлеры теряют клиентов из-за плохого сервиса",
    "NPS и отзывы покупателей: кто в лидерах, а кто в аутсайдерах",
    "промокоды и скидки: маркетинговый успех или финансовый провал",
    "использование big data в ритейле: есть ли толк",
    # Технологии
    "технологические проблемы Wildberries: баги, сбои, инвестиции в IT",
    "инвестиции Ozon в роботизацию: окупается ли это",
    "цифровизация Магнита: умные полки и автоматизация касс",
    "IT-инфраструктура ритейлеров: стабильность и отказоустойчивость",
    "внедрение ИИ в управлении цепочками поставок",
    # Персонал
    "текучка кадров в ритейле: причины и последствия",
    "как ритейлеры экономят на персонале и к чему это приводит",
    "обучение и развитие сотрудников: инвестиции или пустая трата",
    "топ-менеджмент ритейлеров: бонусы и провалы",
    # Конкуренция
    "Магнит vs Светофор: битва за цену и качество",
    "Ozon и Wildberries: борьба за долю рынка и прибыль",
    "влияние роста маркетплейсов на традиционные сети",
    "как ритейлеры реагируют на демпинг конкурентов",
    # Логистика
    "проблемы доставки последней мили: репутационные риски",
    "как ритейлеры управляют возвратами и уценкой",
    "логистика в регионах: затраты и эффективность",
    "складские запасы и оборачиваемость: кто лучше управляет",
    # Регуляторные и правовые риски
    "налоговые проверки ритейлеров: сколько теряют лидеры",
    "дела ФАС против ритейлеров: картели и недобросовестная конкуренция",
    "как ритейлеры адаптируются к изменениям законодательства",
    "юридические споры с поставщиками и арендодателями",
    # Экология и ESG
    "экологические скандалы: упаковка и отходы ритейлеров",
    "ESG-рейтинги ритейлеров: реальность или зеленый пиар",
    "как ритейлеры внедряют раздельный сбор и переработку",
    "углеродный след и его влияние на стоимость компаний",
    # Международная экспансия
    "выход российских ритейлеров на зарубежные рынки: неудачные примеры",
    "глобальные игроки и российский ритейл: кто кого",
    "китайские маркетплейсы и их влияние на локальный рынок",
    # Макроэкономика и тренды
    "инфляция и её влияние на продуктовый ритейл",
    "изменение потребительских привычек и реакция ритейлеров",
    "как ритейлеры переживают экономические кризисы",
    "влияние санкций на ассортимент и цены",
    "прогноз развития ритейла в России: оптимизм или пессимизм",
    "консолидация рынка: слияния и поглощения",
    "выход IPO ритейлеров: история успеха или провала",
    "динамика акций ритейлеров и настроения инвесторов"
]
        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "Пост должен быть длиной 500–600 символов (4–5 абзацев). Action Item — в самом конце, не более 1 предложения.\n"
